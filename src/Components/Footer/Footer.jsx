    ...
    return(				
        <Container as='footer' h="6vh" maxW="100vw" display="flex" flexDirection="row" 
            ...
            alignItems={'center'} fontSize={{base:'8',sm:'12',md:'18'}}>
                <Box fontFamily={'Roboto Condensed'}  color={'whitesmoke'}>{<strong><FontAwesomeIcon icon={faCopyright} /> Copyright - <Link _hover={{color:'rgba(253, 240, 123, 0.986)', textDecoration:'none'}}> AF desarrollos</Link> - 2023 </strong>}</Box>
