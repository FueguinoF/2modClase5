    ...
    return(				
        <Container as='footer' h="6vh" maxW="100vw" display="flex" flexDirection="row" 
            ...
            alignItems={'center'} fontSize={{base:'9',sm:'12',md:'18'}}>
                <Box fontFamily={'Rockwell'} color={'whitesmoke'}>{<strong><FontAwesomeIcon icon={faCopyright} /> Copyright - <Link _hover={{color:'cyan', textDecoration:'none'}}> AF desarrollos</Link> - 2023 </strong>}</Box>
